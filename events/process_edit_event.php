...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt->bind_param("sssdssssiii", $eventTitle, $eventDescription, $photoPath, $eventPrice, $eventType, $eventDate, $eventStartTime, $eventEndTime, $venueId, $eventCapacity, $eventId);
