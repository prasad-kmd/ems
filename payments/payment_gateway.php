...
?>
        ...
        <head>
            ...
            <script src="../assets/js/payment_gateway.js"></script>
        ...
        <body>
            ...
            <div class="ui fluid vertical menu" style="padding: 5px;">
                <span class="item" style="font-family: Neuropol;">Payment for Selected Event Booking</span>
            </div>
            <!-- menu ends -->
            <!-- Nav Bar ends -->
            ...
            <div class="ui placeholder segment">
                <div class="ui two column very relaxed stackable grid">
                    ...
                    <div class="middle aligned column">
                        <form class="ui form" style="padding: 25px;" method="POST" action="process_payment_gateway.php">
                            <span style="font-family: 'Orbit';">
                                ...
                                <div class="fluid field">
                                    <label for="payment_method">Total Payment (LKR)</label>
                                    <div class="ui disabled input">
                                    <input type="number" value="<?php echo $totalPrice; ?>">
                                    </div>
                                </div>
                                </div>
                                <div class="two fluid fields">
                                ...
                                <button class="ui fluid button" type="submit" style="font-family: 'Neuropol';">Proceed the Payment</button>
                            </span>
                        </form>
            ...
            <h4 class="ui horizontal divider header">
                <i class="life ring outline loading icon"></i>
                Your Booking Summary
            </h4>
            <table class="ui definition table">
                <tbody style="padding: 5px;">
                    <tr>
                        <td class="two wide column">Event</td>
...
<!-- hidden -->
            <div class="form-container" style="visibility: hidden;">
                ...
                <div class="field-container">
                    <label for="card_number">Card Number</label><span id="generatecard">generate random</span>
